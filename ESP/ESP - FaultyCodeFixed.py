...
def check_age (num_junior):
    ...
    for i in range(1,num_junior+1):
        flag = True
    
        while flag:
            age = int(input('Please enter the age for junior ticket {} : '.format(i)))
...
def output_summary(final_total, name, email, order_date, entry_date):
    ...
    print("Number of Junior Tickets: {}".format(final_total.get("num_junior")))
...
name = str(input ("Please enter a name for the booking: "))
email = get_email()
